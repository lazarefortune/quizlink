export const fr = {
  ...
  quiz: {
    ...
    quitConfirmDescription: "Ta tentative sera marquée comme abandonnée.",
    quitContinuePlaying: "Continuer le quiz",
    introBadge: "Quiz",
    readyToStart: "Prêt à commencer ?",
    multipleAttemptsTitle: "Tentatives autorisées",
    singleAttemptTitle: "Tentative unique",
  ...
  dashboard: {
    ...
    responses: "Réponses",
    completedAttempts: "Tentatives terminées",
    averageDuration: "Durée moyenne",
    latestAttempts: "Dernières tentatives",
    anonymousParticipant: "Participant anonyme #{number}",
    viewAttemptDetails: "Voir le détail",
    ...
    attemptAbandoned: "Tentative abandonnée",
    attemptNotFinished: "Non terminé",
