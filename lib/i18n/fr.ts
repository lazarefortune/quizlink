export const fr = {
  ...
  auth: {
    ...
    signUp: {
      ...
      codeSent: "On vient de t'envoyer un code de vérification.",
      nameStep: {
        title: "Comment tu t'appelles ?",
        description: "On a besoin de ton prénom ou pseudo pour personnaliser ton espace.",
      },
      passwordStep: {
        title: "Choisis ton mot de passe",
        description: "Dernière étape avant de créer ton compte.",
        button: "Créer mon compte",
      },
      legalRequiredError:
    ...
    verifyEmail: {
      ...
      resendCooldown: "Renvoyer le code dans {seconds} s",
      ...
      codeSentTo: "On vient de t'envoyer un code à {email}",
      notYourEmail: "Ce n'est pas ton email ?",
      backToSignUp: "Retourner à l'inscription",
      verifiedRedirecting: "Email vérifié. Redirection…",
  ...
  builder: {
    ...
    finalizeQuiz: "Finaliser le quiz",
    ...
    quizInfoPanelTitle: "Prépare ton quiz",
    quizTitleSectionTitle: "Titre du quiz",
    quizOptionsSectionTitle: "Options du quiz",
    ...
    openQuizSettingsLabel: "Paramètres du quiz",
    sidebarQuizInfoLabel: "Infos du quiz",
    sidebarQuizInfoSubtitle: "Titre et options",
    sidebarQuizSection: "Quiz",
    quizTitleUntitledHint: "Donne un titre à ton quiz",
    addQuestion: "Ajouter une Question",
    noQuestions: "Aucune question pour le moment.",
    emptyQuestionsTitle: "Tu y es presque !",
    emptyQuestionsTitleDesktop: "Tu y es presque !",
    emptyQuestionsDescription:
      "Ajoute des questions pour rendre ton quiz génial.",
    emptyQuestionsDescriptionDesktop:
      "Ajoute des questions pour rendre ton quiz génial.",
    ...
    settingsSummary: {
      ...
      edit: "Modifier",
      privateQuiz: "Quiz privé",
      publicQuiz: "Quiz public",
      correctionAfterQuestion: "Correction après chaque question",
      answersAtEnd: "Réponses visibles à la fin",
      randomizeQuestions: "Questions mélangées",
      randomizeOptions: "Réponses mélangées",
      timeLimitSeconds: "{n} s par question",
      timeLimitMinutes: "{n} min par question",
      timeLimitMixed: "{minutes} min {seconds} s par question",
    },
