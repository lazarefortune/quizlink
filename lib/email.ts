...
export async function sendVerificationEmail(
  ...
  const subject =
    locale === "fr"
      ? "Vérifiez votre adresse email - QuizSnap"
      : "Verify your email address - QuizSnap";
  ...
  const html =
    ...
    <html>
      ...
      <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
        ...
        <p>Bonjour,</p>
        <p>Merci de vous être inscrit sur QuizSnap. Pour activer votre compte, veuillez utiliser le code de vérification suivant :</p>
        ...
        <p style="margin-top: 30px; color: #6b7280; font-size: 14px;">Cordialement,<br>L'équipe QuizSnap</p>
      </body>
    </html>
  `
      : `
    ...
    <html>
      ...
      <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
        ...
        <p>Hello,</p>
        <p>Thank you for signing up for QuizSnap. To activate your account, please use the following verification code:</p>
        <div style="background-color: #f3f4f6; border: 2px solid #2563eb; border-radius: 8px; padding: 20px; text-align: center; margin: 20px 0;">
          <h2 style="color: #2563eb; font-size: 32px; letter-spacing: 4px; margin: 0;">${code}</h2>
        </div>
        <p>This code expires in 15 minutes.</p>
        <p>If you did not create an account, you can ignore this email.</p>
        <p style="margin-top: 30px; color: #6b7280; font-size: 14px;">Best regards,<br>The QuizSnap Team</p>
      </body>
    </html>
  `;
...
export async function sendPasswordResetEmail(
  ...
  const subject =
    locale === "fr"
      ? "Réinitialisez votre mot de passe - QuizSnap"
      : "Reset your password - QuizSnap";
...
export async function sendEmailChangeCode(
  ...
  const subject =
    locale === "fr"
      ? "Code de vérification pour changement d'email - QuizSnap"
      : "Email change verification code - QuizSnap";
